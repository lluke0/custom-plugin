...
| [`im-not-ai`](./im-not-ai/) | AI가 쓴 한글 텍스트를 사람이 쓴 글처럼 윤문해주는 오케스트레이터. 한국 번역학계 8대 번역투 유형 + post-editese 정량 트랙 기반으로 40+ AI 티 패턴 탐지·분류. `/humanize`, `/humanize-redo` 포함. (원본: [epoko77-ai/im-not-ai](https://github.com/epoko77-ai/im-not-ai) v2.0.0, MIT) |
